...
const boom = require('boom'), //Boom gives us some predefined http codes and proper responses
    ...
    { expand, highlight, parseSpellcheck, parseFacets, parseJsonFacets, getLinks } = require('../solr/lib/util');
    ...
    getHierachicalResults: function(request, reply){
        searchResults.get(request.query).then( (results) => {
            ...
            if(request.query.facets && results.facets){
                ...
                facets = parseJsonFacets(results.facets);
            }
            ...
            reply({
                ...
                hasMore: hasMore,
                links: getLinks({...request.query}, hasMore),
